...
//current store selection, private API, don't put API doc for this
@property (strong, nonatomic) TBStoreInfo *currentStore;

+ (TBSDKUser *)currentUser;

- (void)setNewStore:(TBStoreInfo*)newStore;
