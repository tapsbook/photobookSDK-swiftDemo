...
/** set fake user */
- (void)setFakeUser:(NSString *)username authToken:(NSString *)authToken storeApiKey:(NSString *)storeApiKey completionBlock:(void (^)(BOOL success, TBSDKUser * sdkUser, NSError *error))completionBlock ;
...
/**
 ...
 @param completionBlock the callback
 */
- (void) updateUser:(NSString *)userName userAvatar:(UIImage *)userAvatar completionBlock:(void (^)(BOOL success, TBSDKUser *sdkUser, NSError *error))completionBlock;
